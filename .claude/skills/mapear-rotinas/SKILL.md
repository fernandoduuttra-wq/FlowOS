...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Claude Code ou validada pelo FlowOS. Se sim, sugerir a skill existente em vez de criar uma nova:
...
**Dependências:** [arquivos do _contexto/, marca/, ou ferramentas externas]
```
...
4. Calibrar o tom e regras conforme `_contexto/preferencias.md` e `_contexto/empresa.md`
