...
description: >
  ...
  negativas. Lê o briefing de _contexto/empresa.md e da pesquisa SEO se existir.
...
- **Contexto do negócio:** `_contexto/empresa.md` (produto/serviço, público, região, diferenciais)
...
Seguir `_contexto/preferencias.md` pra tom.
...
- **Chamadas** (telefone): puxar de `_contexto/empresa.md`
...
- Copies seguem `_contexto/preferencias.md` estritamente. Sem jargão de marketing se o público não usa.
