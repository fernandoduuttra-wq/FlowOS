...
5. **Tom:** seguir `_contexto/preferencias.md`. Sem jargão de marketing. Sem "premium", "qualidade ímpar", "experiência diferenciada".
...
- **Evitar (tom de marketing genérico):** ✨ 🎉 💯 🚀 (a menos que combine com o tom da marca em `_contexto/preferencias.md`)
