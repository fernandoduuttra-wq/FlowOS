...
name: atualizar
description: >
  Varre o projeto e atualiza os arquivos de contexto (`_contexto/`, `AGENTS.md` e `marca/design.json`)
  que ficaram desatualizados em relação
...
1. _contexto/empresa.md — falta o cliente "Acme" (vi pasta clientes/Acme/ criada em [data])
2. AGENTS.md — tem regra "propostas vão em propostas/" mas vejo propostas em clientes/<x>/propostas/
3. _contexto/estrategia.md — fala em "fechar 1º cliente em fevereiro", já é abril e tem 3 clientes ativos
