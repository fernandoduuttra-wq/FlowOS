...
- **Contexto:** `_contexto/empresa.md`. Visual, se precisar: `marca/design.json` (a fonte da verdade)
...
author: "<nome configurado em _contexto/empresa.md>"
keywords:
  - keyword principal
  - variação 1
  - variação 2
...
**Regras de escrita** (seguir `_contexto/preferencias.md` estritamente):
