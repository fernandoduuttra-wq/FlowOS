...
1. Ler `_contexto/empresa.md` pra extrair: produtos/serviços, região, público-alvo, diferenciais
...
3. **Copies dos anúncios:**
   - Seguir tom de `_contexto/preferencias.md`
...
- Copies e textos seguem `_contexto/preferencias.md` estritamente
