...
**Estrutura de pastas:**
- `_contexto/` — quem é a empresa, como falamos, foco atual
...
*(Marcar conforme for instalando os MCPs. Ads têm três rotas: CSV exportado (padrão, zero setup), conector MCP oficial da Meta (conversa e mexe nas campanhas) ou API direta via `scripts/meta-ads.py` (roda agendada e acumula histórico). Comparativo em `.claude/skills/relatorio-ads/references/fontes-de-dados.md`.)*
